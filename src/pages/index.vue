...
<template>
  <header class="container flex justify-end p-4 mx-auto">
    <button
    ...
    >
      <transition
        ...
        enter-from-class="transform -translate-y-full scale-50"
        enter-to-class="transform translate-y-0"
        leave-from-class="transform translate-y-0"
        leave-to-class="transform translate-y-full scale-50"
        mode="out-in"
      >
        <svg
  ...
  <main class="px-4 mx-auto max-w-3xl">
    <h1 class="py-24 text-6xl text-center text-gray-700 dark:text-gray-100 transition-colors">
